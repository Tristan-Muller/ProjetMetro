...
int main (){
    ...
    char *sta_chemin1 = NULL;
    char* sta_chemin2 = NULL;
                ...
                if (pause() != 0){
                    ...
                    if (pause() != 0){
                        ...
                        if (pause()){
                            ...
                            sta_chemin1 = choix_sta_chemin();
                            printf("\nChoisissez votre station d'arrivée : \n(entrez le numero associé à la station)\n");                            
                            sta_chemin2 = choix_sta_chemin();
                            printf("\nDepuis %s, \n", sta_chemin1);

                            Un_truc* dep = chercher_station(abr , sta_chemin1);
                            Un_truc* arr = chercher_station(abr , sta_chemin2);

                            dijkstra(liste_sta, dep);
                            printf("\n");

                            //Un_elem* co = (Un_elem*)malloc(sizeof(Un_elem));
                            Un_elem* co = cherche_chemin(arr);
